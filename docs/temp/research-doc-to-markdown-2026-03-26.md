...
| **测试评分（内部）** | N/A | N/A | N/A | N/A | N/A | **0.9979**（32/32）|
...
| DOCX | ✅ 完整 | 1.0000 | 无 |
| XLSX | ✅ 完整 | 1.0000 | 无 |
| EPUB | ✅ 完整 | 0.9775 | 已补媒体噪声与 Gutenberg boilerplate 清理，仍可继续提升长书结构整理 |
...
**最新评测结果（2026-03-30，release runner）**：32/32 全部通过，平均分 0.9979。其中 EPUB 为 2/2 通过、平均分 0.9775；PPTX 为 4/4，当前样本集中已覆盖基础 notes / chart / table / shape 语义。需要注意，这证明当前样本集表现很强，但不等于所有公开能力都已完全闭环。
