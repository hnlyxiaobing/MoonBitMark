...
- MCP `response_mode=json` 已提供 explanations，覆盖 heading / table / OCR / uncertainty
...
4. 继续增强 MCP 解释性输出，目前已有 heading / table / OCR / uncertainty 的第一轮解释，但还没有完整的 normalizer 决策轨迹和全量 compare debug 解释。
